    ...
    if (e.getSource() == resetButton) {
      ...
      if (logininfo.containsKey(userID)) {
        if (logininfo.get(userID).equals(password)) {
          ...
          messLabel.setText("Invalid credentials!");
          JOptionPane.showMessageDialog(
            null,
            "Invalid credentials!! Please input the correct username or password.",
            "ACCESS DENIED!!",
        ...
        messLabel.setForeground(Color.red);
        //messLabel.setText("Invalid username");
        messLabel.setText("Invalid credentials!");
        JOptionPane.showMessageDialog(
          null,
          "Invalid credentials!! Please input the valid username or password",
          "ACCESS DENIED!!",
          JOptionPane.WARNING_MESSAGE
        );
      }
